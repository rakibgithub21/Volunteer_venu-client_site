...
const Footer = () => {
    return (
        <footer className="px-4 divide-y mt-20 bg-base-300 text-gray-500 font-roboto">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Volunteer Venue</span>
                    </a>
                    <form className='mt-5 '>
                        <fieldset className="form-control w-80">
                            ...
                            <div className="join">
                                <input type="text" placeholder="username@site.com" className="input bg-rose-100 input-bordered join-item" />
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-gray-900">Contact Information</h3>
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="#">456 Phetchaburi, Bangkok</a>
                            </li>
                            <li>
                                +66 81 234 5678
                            </li>
