            ...
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                ...
                <form  className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                    ...
                    <label className="block">
                        ...
                        <textarea data-tooltip-id="my-tooltip-4" placeholder="Add Your Valuable Comment..." required rows={3} className="textarea placeholder:text-black   bg-red-200 textarea-bordered textarea-lg text-black w-full " ></textarea>
                    </label>
